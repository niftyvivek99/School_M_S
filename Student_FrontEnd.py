...
class Std_info():
    def __init__(self, master):
        ...
        self.master.iconbitmap("C:/Users/97798/Downloads/logo.ico")
        ...
        def information():
            ...
            def Add():
                if (len(self.name.get()) != 0):
                    Student_BackEnd.insert(self.name.get(), self.fname.get(), self.mname.get(), self.address.get(),
            ...
            self.listbox = Listbox(self.Frame_2, width=75, height=20, font=('times', 12, 'bold'))
